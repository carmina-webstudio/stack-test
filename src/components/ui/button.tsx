...
// Run through cn() so a className passed in (e.g. a different background) replaces the
// variant's default instead of both classes landing on the element and the CSS order deciding.
